...
public class FPAIO_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.Space();
        // Selection Manager Inspector
        t.selectionManager = (SelectionManager)EditorGUILayout.ObjectField(new GUIContent("Selection Manager", "Selection Manager of this scene"), t.selectionManager, typeof(SelectionManager), true);
